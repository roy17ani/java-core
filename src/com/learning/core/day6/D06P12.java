...
public class D06P12 {
	...
	public static void main(String[] args) {
        ...
        // Store staff members in Hashtable with staff member id as key
        ...
        // Take input from user for new staff member details
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter new staff member details in the format: id name designation department");
        String input = scanner.nextLine();
        scanner.close();

        // Parse input and add new staff member if not already exist
